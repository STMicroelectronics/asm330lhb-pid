...
typedef enum
{
  ...
  ASM330LHB_LP_ODR_DIV_2              = 0x01,
  ASM330LHB_LP_ODR_DIV_4              = 0x80,
  ASM330LHB_LP_ODR_DIV_10             = 0x81,
  ASM330LHB_LP_ODR_DIV_20             = 0x82,
  ASM330LHB_LP_ODR_DIV_45             = 0x83,
  ASM330LHB_LP_ODR_DIV_100            = 0x84,
  ASM330LHB_LP_ODR_DIV_200            = 0x85,
  ASM330LHB_LP_ODR_DIV_400            = 0x86,
  ASM330LHB_LP_ODR_DIV_800            = 0x87,
...
typedef enum
{
  ...
  ASM330LHB_STAMP_IN_XL_DATA     = 2,
  ASM330LHB_STAMP_IN_GY_XL_DATA  = 1,
...
int32_t asm330lhb_den_mark_axis_x_set(const stmdev_ctx_t *ctx,
                                      uint8_t val);
int32_t asm330lhb_den_mark_axis_x_get(const stmdev_ctx_t *ctx,
                                      uint8_t *val);

int32_t asm330lhb_den_mark_axis_y_set(const stmdev_ctx_t *ctx,
                                      uint8_t val);
int32_t asm330lhb_den_mark_axis_y_get(const stmdev_ctx_t *ctx,
                                      uint8_t *val);

int32_t asm330lhb_den_mark_axis_z_set(const stmdev_ctx_t *ctx,
                                      uint8_t val);
